              ...
              <div className="text-white w-full py-7 px-7 font-bold text-xl flex justify-between md:w-[90%]">
                ...
                <div className="flex items-center gap-4 justify-between">
                  <a
                    href="/Jayasurya.pdf"
                    download
                    className="w-fit cyber-button flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all"
                  >
                    <Download className="w-4 h-4" />
                    Resume
                  </a>
                  <div
                    className="font-regular! text-md cursor-pointer"
                ...
                <div className="w-[90%] flex">
                  ...
                  <div className="w-full md:w-[50%] flex flex-col gap-10 justify-center items-center">
                    ...
                    <div className="text-white/60 w-[60%] flex flex-col gap-2 font-medium">
                      <a
                        href="https://github.com/jayasurya-ms"
                        target="_blank"
