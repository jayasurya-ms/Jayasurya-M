...
export default function CallToAction() {
  ...
  return (
    <section className="py-32 px-6 lg:px-24 bg-linear-to-b from-[#0a031c] via-[#1b073c] to-[#010204] relative z-10 w-full overflow-hidden">
      ...
      <div
        ref={ctaRef}
        className="max-w-5xl mx-auto flex flex-col items-center text-center cyber-glass-card-purple py-20 px-6 rounded-[3rem] overflow-hidden relative"
      >
        ...
        <p className="text-xl text-white/60 font-light mb-12 max-w-xl relative z-10">
        ...
        <button
          ...
          className="cyber-button group relative inline-flex items-center justify-center gap-3 px-10 py-4 font-semibold rounded-full overflow-hidden transition-all z-10"
        >
